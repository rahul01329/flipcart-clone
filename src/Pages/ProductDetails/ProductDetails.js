    ...
    <div className="ProductDetails">
      ...
      <div className="ProductDetails-right">
        ...
        <div className="offers">
          ...
          />{' '}
          <div>
            <b> Partner Offer </b> Sign up for Flipkart Pay Later and get
            Flipkart Gift Card worth up to₹ 500 * Know More{' '}
          </div>{' '}
        </div>{' '}
        <div className="offers">
          <img
          ...
          <div className="RatingsAndReviews-container">
            ...
            <ul className="RatingsAndReviews-charts">
              <li>
                ...
                <div className="bar">
                  <div className="innerbar" style={{ width: '80%' }}>
                    {' '}
                  </div>{' '}
                </div>{' '}
              </li>{' '}
              <li>
                ...
                <div className="bar">
                  <div className="innerbar" style={{ width: '50%' }}>
                    {' '}
                  </div>{' '}
                </div>{' '}
              </li>{' '}
              <li>
                ...
                <div className="bar">
                  <div className="innerbar" style={{ width: '33.6%' }}>
                    {' '}
                  </div>{' '}
                </div>{' '}
              </li>{' '}
              <li>
                ...
                <div className="bar">
                  <div className="innerbar" style={{ width: '29.6%' }}>
                    {' '}
                  </div>{' '}
                </div>{' '}
              </li>{' '}
              <li>
                ...
                <div className="bar">
                  <div className="innerbar" style={{ width: '10%' }}>
                    {' '}
                  </div>{' '}
                </div>{' '}
              </li>{' '}
